    ...
    return (
        ...
        className="bg-white rounded-lg shadow-md w-full max-w-sm mx-auto">
            ...
            <p className="text-center text-gray-600 text-lg font-light pr-6 pl-6">
                Scan the QR cod ebelow with your authenticator app
            </p>
            <div className="p-6">
                <div className="flex justify-center">
                    <img src={response.qrCode} alt="QR Code" className="mb-4 border rounded-md"/>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <input readOnly defaultValue="" value={response.secret} className="w-full p-4 border rounded mt-2 text-xs text-gray-600"
                    onClick={copyClipBoard} />
                </div>
                <button onClick={onSetupComplete} className= "w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600">
