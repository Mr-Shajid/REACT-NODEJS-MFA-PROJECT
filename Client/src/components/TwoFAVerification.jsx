...
const TwoFAVerification = ( {onVerifySuccess, onResetSuccess} ) => {
    ...
    return (
        ...
        className="bg-white rounded-lg shadow-md w-full max-w-sm mx-auto" action="">
            <div className="pt-6">
            ...
            <div className="p-6">
                ...
                <button type="button" onClick={handleReset} className="w-full bg-gray-500 text-white py-2 rounded-md mt-4">Reset 2FA</button>
            </div>
        </form>
    );
};
